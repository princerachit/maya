...
func (s *HTTPServer) snapshotV1alpha1SpecificRequest(resp http.ResponseWriter, req *http.Request) (interface{}, error) {
	...
	switch req.Method {
	case "POST":
		return s.create(resp, req)
	case "PUT":
		return s.revert(resp, req)
	case "GET":
		return s.list(resp, req, strings.TrimPrefix(req.URL.Path, "/latest/snapshots/"))
	case "DELETE":
		return s.delete(resp, req, strings.TrimPrefix(req.URL.Path, "/latest/snapshots/"))
	default:
...
func (s *HTTPServer) create(resp http.ResponseWriter, req *http.Request) (interface{}, error) {
	...
	snapshotOps, err := snapshot.NewSnapshotOperation("")
	if err != nil {
		glog.Errorf("error creating snapshotOps object")
		return nil, err
	}

	volType, err := snapshotOps.GetVolumeType(snap.Spec.VolumeName)
	if err != nil {
		glog.Error(err)
		return nil, err
	}
...
func (s *HTTPServer) list(resp http.ResponseWriter, req *http.Request, volName string) (interface{}, error) {
...
func (s *HTTPServer) delete(resp http.ResponseWriter, req *http.Request, snapName string) (interface{}, error) {
	snap := v1.VolumeSnapshot{}
...
func (s *HTTPServer) revert(resp http.ResponseWriter, req *http.Request) (interface{}, error) {
